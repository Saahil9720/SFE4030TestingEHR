      ...
      <div class="w3-card-4 w3-margin w3-black">
        <div class="w3-container center-block">
          ...
          if (isset($_GET['s_id'])) {
            ...
            <hr color="#333333" />
            <h3 class="text-white ">ID:
              <?php echo $row['id'] . "<br />"; ?></br>
            </h3>
            <h3 class="text-white"> Name:
              <?php echo $row['f_name'];
              echo $row['l_name'] . "<br />"; ?></br>
            </h3>
            <h3 class="text-white">Email/Gmail Address:
              <?php echo $row['email'] . "<br />"; ?></br>
            </h3>
            <h3 class="text-white"> Contact Number:
              <?php echo $row['contact'] . "<br />"; ?></br>
            </h3>
            <h3 class="text-white"> Clinic Address:
              <?php echo $row['address'] . "<br />"; ?></br>
            </h3>
            <h3 class="text-white"> Qualification:
              <?php echo $row['qualification'] . "<br />"; ?></br>
            </h3>
            <h3 class="text-white"> BMDC Registration Number:
              <?php echo $row['bmdc_reg_num'] . "<br />"; ?></br>
            </h3>
            <h3 class="text-white"> Specialism:
              <?php echo $row['specialist'] . "<br />" . "<br />" . "<br />"; ?>
            </h3>
            <h1 class=" text-center font-weight-bold  text-warning"> Visiting/Appointment Information</h1>
            <hr color="#333333" />
            <p class="text-white  font-weight-bold">Schedule ID:
              <?php echo $row['s_id'] . "<br />"; ?>
            </p>
            <li>
              <?php echo $row['Day_Time1'] . "<br />"; ?></br>
            </li>
            <li>
              <?php echo $row['Day_Time2'] . "<br />"; ?></br>
            </li>
            <li>
              <?php echo $row['Day_Time3'] . "<br />"; ?></br>
            </li>
            <li>
              <?php echo $row['Day_Time4'] . "<br />"; ?></br>
            </li>
            <li>
              <?php echo $row['Day_Time5'] . "<br />"; ?></br>
            </li>
            <li>
              <?php echo $row['Day_Time6'] . "<br />"; ?></br>
            </li>
            <li>
              <?php echo $row['Day_Time7'] . "<br />"; ?></br></br>
            </li>
          </div>
        </div>
      </div>
        ...
        <div class="w3-col 18 s12">
          ...
          <div class="w3-card-4 w3-margin w3-black">
            <div class="w3-container">
              ...
              </h3><br /> <b><input type="pid" name="pid" /> </b><br /><br /><br />
            ...
            <h3><label for="booking_date">Select Date:</label></h3><br /><b><input type="date"
                name="booking_date"></b><br /><br /><br />
            ...
            <button class="btn"><i class="fa  fa-2x "></i> <input style="color:#000000" class="font-weight-bold"
                type="submit" name="submit" value="submit"></i></button><br />
          ...
          <div class="container ">
            <ul class="pager font-weight-bold text-monospace">
              <li class="center"><a href="../View_Doctor_Appointment_Schedule/doctor_schedule_list.php">Previous</a>
              </li>
