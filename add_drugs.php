...
<!-- <div class="w3-col 18 s12"> -->
  ...
  <!-- <div class="w3-card-4 w3-margin w3-black"> -->
    <div class="w3-container">
                     <h1 style="font-family: 'Montserrat', sans-serif; color: #4d0d0dcb; font-size:50px; font-weight:700;"><b> ADD DOCTOR </b> </h1><p style="font-size:20px">Please fill in this form to register a doctor account.</p>
...
<div class="inputbox">
<label for="email" style="font-size:16px">Email:</label><input type="email"placeholder="Your Email" name="email"required>
</div>

<br>

<div class="inputbox">
<label for="specialist" style="font-size:16px">Specialist:</label> <select style="font-size:16px" name="specialist"required>
  ...
  <option style="font-size:16px" value="dentist"required>Dentist</option>
   <option style="font-size:16px" value= "cardiac_electrophysiologist"required> Cardiac electrophysiologist</option>

    <option style="font-size:16px" value="cardiologist"required>Cardiologist </option>
 
   <option style="font-size:16px" value="surgeon"required>Surgeon </option></select> 
</div> 

<br>

<div class="inputbox">
<label for="qualification" style="font-size:16px">Qualification:</label><input type="text"placeholder="Your Qualification" name="qualification"required>
</div>

<br>

<div class="inputbox">
<label for="pswd" style="font-size:16px">Create New Password  :</label><input type = "password" placeholder="Your Password"name="pswd"required> <br> <p style="font-size:10px"> Password should be more than 8 characters long </p>
</div>
