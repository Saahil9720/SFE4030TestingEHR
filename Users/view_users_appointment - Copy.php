...
<th class="table-dark" style=" text-align:center; font-size:25px"><h3> Appointment To</h3></th>
<th class="table-dark" style=" text-align:center; font-size:25px"><h3> Appointment Date</h3></th>
<th class="table-dark" style=" text-align:center; font-size:25px"><h3>Appointment Time</h3></th>
<th class="table-dark" style=" text-align:center; font-size:25px"><h3>Status</h3></th>
<th class="table-dark" style=" text-align:center; font-size:25px"><h3>
	<input class="alert-danger"type ="submit" value="Cancel Booking" name="submit1"></h3></th>
...
$email=$_SESSION['email'];
	...
	$doctor_sid_squery=mysqli_query($db,$doctor_sid_show_squery);
				   ...
				   {
				   ?>
                  <h3 class="active font-weight-bold text-warning">  Your ID :  <?php
echo $d_s_row['id'];  echo "  " ;		         
 }   ?> &nbsp;
 <br> <input class="text-center text-dark" type = "id" name="id"  placeholder=" Enter Your ID "/></h3><hr> 
