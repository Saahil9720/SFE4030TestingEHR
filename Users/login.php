...
{
$error_msg="Fill the necessary details";
}
...
?>
      ...
      <!-- <div class="w3-clear w3-margin" >
        ...
        <div class="inputbox">
            <label for="email"style="font-size:16px">Email Address: </label> <br>
      ...
      <!-- <label for="email"><b> Email</b></label>
          ...
          <div class="inputbox">
            <label for="pswd" style="font-size:16px">Password:</label><br>
            <input type = "password" style="font-size:16px" placeholder="Your password" name="pswd"required>  
          </div> 
